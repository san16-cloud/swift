...
import { legalFunctions } from "../legal/LegalModals";

export function Footer() {
  const openTerms = () => {
    if (legalFunctions.openTerms) {
      legalFunctions.openTerms();
    }
  };

  const openPrivacy = () => {
    if (legalFunctions.openPrivacy) {
      legalFunctions.openPrivacy();
    }
  };
